...
for name,fn in [("add_anchor",lambda:a+b),
                ("sum_all",lambda:a.sum()),
                ("mean_all",lambda:a.mean()),
                ("amax_dim0",lambda:a.amax(0)),
                ("amax_dim1",lambda:a.amax(1)),
                ("maximum",lambda:torch.maximum(a,b)),
                ("minimum",lambda:torch.minimum(a,b)),
                ("eq",lambda:a.eq(b)),
                ("gt",lambda:a.gt(b)),
                ("pow2",lambda:a.pow(2.0)),
                ("clamp",lambda:a.clamp(-1.0,1.0)),
