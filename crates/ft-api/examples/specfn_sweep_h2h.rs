    ...
    let tt = |w: u8| {
        ...
        for _ in 0..7 {
            ...
            match w {
                ...
                1 => {
                    let _ = s.tensor_erfinv(xe);
                }
                2 => {
                    let _ = s.tensor_erfcx(xa);
                }
                3 => {
                    let _ = s.tensor_special_bessel_j0(xa);
                }
                4 => {
                    let _ = s.tensor_special_bessel_j1(xa);
                }
                5 => {
                    let _ = s.tensor_special_airy_ai(xa);
                }
                6 => {
                    let _ = s.tensor_special_modified_bessel_k0(xp);
                }
                7 => {
                    let _ = s.tensor_polygamma(1, xp);
                }
                _ => {
                    let _ = s.tensor_multigammaln(xp, 2);
                }
            }
