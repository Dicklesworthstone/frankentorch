...
"#;
    ...
    rep(
        "hardtanh",
        t1(&a, |s, x| {
            let _ = s.tensor_hardtanh(x);
        }),
    );
    rep(
        "hardsigmoid",
        t1(&a, |s, x| {
            let _ = s.tensor_hardsigmoid(x);
        }),
    );
    rep(
        "hardswish",
        t1(&a, |s, x| {
            let _ = s.tensor_hardswish(x);
        }),
    );
    rep(
        "relu6",
        t1(&a, |s, x| {
            let _ = s.tensor_relu6(x);
        }),
    );
    rep(
        "leaky_relu",
        t1(&a, |s, x| {
            let _ = s.tensor_leaky_relu(x);
        }),
    );
    rep(
        "elu",
        t1(&a, |s, x| {
            let _ = s.tensor_elu(x);
        }),
    );
    rep(
        "selu",
        t1(&a, |s, x| {
            let _ = s.tensor_selu(x);
        }),
    );
    rep(
        "celu",
        t1(&a, |s, x| {
            let _ = s.tensor_celu(x, 1.0);
        }),
    );
    rep(
        "softplus",
        t1(&a, |s, x| {
            let _ = s.tensor_softplus(x);
        }),
    );
    rep(
        "mish",
        t1(&a, |s, x| {
            let _ = s.tensor_mish(x);
        }),
    );
    rep(
        "silu",
        t1(&a, |s, x| {
            let _ = s.tensor_silu(x);
        }),
    );
    rep(
        "tanhshrink",
        t1(&a, |s, x| {
            let _ = s.tensor_tanhshrink(x);
        }),
    );
    rep(
        "hardshrink",
        t1(&a, |s, x| {
            let _ = s.tensor_hardshrink(x, 0.5);
        }),
    );
    Ok(())
}
