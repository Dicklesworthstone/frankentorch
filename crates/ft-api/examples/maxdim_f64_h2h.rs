...
fn main() {
    ...
    let t = bench(9, || { let t0 = Instant::now(); let o = s.tensor_max_dim(a, 1).unwrap(); let e = t0.elapsed().as_micros(); std::hint::black_box(o); e });
    println!("[{tag}] max_dim f64 [4096,4096] dim=1: {:.2} ms", t as f64 / 1000.0);
}
