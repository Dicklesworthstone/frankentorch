    ...
    let tt = |w: u8| {
        ...
        for _ in 0..7 {
            ...
            match w {
                ...
                1 => {
                    let _ = s.tensor_special_chebyshev_polynomial_t(x, 5);
                }
                2 => {
                    let _ = s.tensor_special_hermite_polynomial_h(x, 5);
                }
                3 => {
                    let _ = s.tensor_special_hermite_polynomial_he(x, 5);
                }
                _ => {
                    let _ = s.tensor_special_laguerre_polynomial_l(x, 5);
                }
            }
